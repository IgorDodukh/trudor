...
abstract class UserRepository {
  Future<Either<Failure, User>> googleSignIn(NoParams params);
  Future<Either<Failure, User>> signIn(SignInParams params);
  Future<Either<Failure, User>> signUp(SignUpParams params);
  Future<Either<Failure, User>> updateUserDetails(UserDetailsParams params);
  Future<Either<Failure, User>> updateUserPicture(String pictureUrl);
