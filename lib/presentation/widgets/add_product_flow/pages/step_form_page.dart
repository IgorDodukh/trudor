...
const EdgeInsets _kOnboardingPagePadding = EdgeInsets.only(left: 25, right: 25);

const double _kTitleTopIndent = 10;

const double _kTitleToBodySpacing = 30;
...
class StepFormPage extends StatelessWidget {
  /// Default constructor of the [StepFormPage] widget.
  ///
  /// Represents an "What's new" screen in iOS 15 style.
  /// It is possible to restyle this widget to match older iOS versions.
  StepFormPage({
